...
if add_selectbox == 'View all :)':
        ...
        ### Bar Plot 1
        data = [go.Bar(x=df.Location,
                    y=df['Number of Households (in 1000)'])]

        layout_1 = go.Layout(title = 'Number of household/Each state', xaxis_title = 'State', yaxis_title = 'Number of Household')
        ...
        layout_3 = go.Layout(title = 'Cat Owning Households/State', xaxis_title = 'State', yaxis_title = 'Cat Owning Households')
        ...
        layout_3 = go.Layout(title = 'Dog Owning Households/State', xaxis_title = 'State', yaxis_title = 'Dog Owning Households')
